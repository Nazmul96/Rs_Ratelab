    ...
    <div class="h-100" data-simplebar>
        ...
        <div id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                <li>
                    <a href="<?= base_url() ?>/admin/frontend/theme_two_image">
                        <i class="mdi mdi-steering"></i>
                        <span>Theme two additional image</span>
                    </a>
                </li>
                <li>
                    ...
                    <div class="collapse" id="sidebarAuth">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="<?= base_url() ?>/admin/frontend/collaboration-section">Collaboration  Section</a>
                            </li>
                            <li>
