...
<section class="pt-50 pb-50 section--bg">
  <div class="container-fluid">
    ...
    <div class="row mt-4">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="by_review_time">
			  ...
			  <div class="company_list_section" style="background:#ECC321; height:200px;" align="center">
                                    
					<h4 class="text-white p-3"><?php echo $company_list_section[0]['settings_value'];?></h4>
					<a class="btn btn-light p-3" href="<?php echo base_url();?><?php echo $company_list_section[2]['settings_value'];?>"><?php echo $company_list_section[1]['settings_value'];?></a>
			  </div>
      ...
      <div class="col-md-9">
        <div class="row show_all_company">
