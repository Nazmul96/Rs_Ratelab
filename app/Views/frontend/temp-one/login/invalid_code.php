...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Invalid code| Adminto - Responsive Admin Dashboard Template</title>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        ?>
                                        <p class="text-black">Do you want to send verify code?
                                            <a href="<?php echo base_url() ?>/user/verify_email" class="fw-medium text-primary">Verify email</a>
                                        </p>  
                                    </div>
                                </div>
