				...
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
			      	...
			      	<div class="d-flex">
						...
						<?php if($agree_policy[0]->settings_value == 1){?>	
						  <div class="form-group col-sm-12">
							<input type="checkbox" name="agree_policy" value="check" id="agree" /> I have read and agree to the Terms and Conditions and Privacy Policy
							<small style="color:red;" class="text-danger">
							<?php if (isset($validation)) {
									echo $validation->getError('agree_policy');
									} ?>
							</small> 
						  </div>
						<?php } ?>			
		        	...
		        	<div class="img" style="background-image: url(../admin/uploads/register/<?php echo $register_section[2]['settings_value'];?>);">

					    <div class="new-image" align="center">
							<p style="color:#FF8C00;font-size: 20px;"><?php echo $register_section[0]['settings_value'];?></p>
							<h3 style="font-size: 28px; color:aliceblue"><?php echo $register_section[1]['settings_value'];?></h3>
							<p class="mt-3" style="color: black;">Have an account? <a href="<?php echo base_url();?>/user/login" class="text--base">Login Now </a></p>					
						</div>
			      </div>
		      </div>
				</div>
