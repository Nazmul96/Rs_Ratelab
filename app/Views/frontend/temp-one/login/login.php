		...
		<div class="container-fluid">
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
		        	...
		        	<div class="img" style="background-image: url(../admin/uploads/login_section/<?php echo $login_section[2]['settings_value'];?>);">

						<div class="new-image" align="center">
						 <p style="color:#FF8C00;font-size: 20px;"><?php echo $login_section[0]['settings_value'];?> Rs RateLab</p>
						 <h3 style="font-size: 28px; color:aliceblue"><?php echo $login_section[1]['settings_value'];?></h3>

					  <?php if($user_registration[0]->settings_value == 1){?>	 
						 <p class="mt-3" style="color: black;">Don't have an account? <a href="<?php echo base_url();?>/user/user_registration" class="text--base">Create Now</a></p>
					   <?php } else {?>
						<h4 class="text-danger">User registration cureently disable</h4>
					   <?php } ?>
