                    ...
                    <div class="card-body contact-form-area">
                        ...
                        <form action="<?php echo base_url();?>/user/company/edit/<?php echo $company->id?>" class="signin-form" method="post" enctype="multipart/form-data">
                            <div class="input-group">
                             ...
                             <div class="input-group">
                                <input type="text" class="form-control" id="companyname" placeholder="Company Name" name="company_name" value="<?php echo $company->company_name;?>">
                             ...
                             <div class="input-group">
                                <input type="url" class="form-control" id="url" placeholder="URL" name="company_url" value="<?php echo $company->url;?>">
                             ...
                             <div class="input-group">
                                <input type="text" class="form-control" id="email" placeholder="Email " name="company_email" value="<?php echo $company->email_address;?>">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="address" placeholder="Address" name="company_address" value="<?php echo $company->company_address;?>">
                            ...
                            <div class="input-group">
                                    <input type="text" name="tags" id="tags" class="form-control" placeholder="Tags" value="<?php echo $company->tags;?>">
                            ...
                            <div class="input-group form-textarea">
                                <textarea class="form-control" id="message" placeholder="Message" name="description"><?php echo $company->description;?></textarea>
