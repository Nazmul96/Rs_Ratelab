...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Invalid token| Adminto - Responsive Admin Dashboard Template</title>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <p class="text-black">Do you want to resend password reset link?
                                            <a href="<?php echo base_url() ?>/user/forgot_password" class="fw-medium text-primary"> Resend Link </a>
                                        </p>  
                                    </div>
                                </div>
