...
class SupportController extends BaseController
{
    public function new_ticket()
    {
       $datas=array();
        ...
        {
            return view('frontend/temp-one/support_ticket/open_support_ticket',$datas);
        }
        if($manage_templates[0]['settings_value'] == 'theme2')
        {
            return view('frontend/temp-two/support_ticket/open_support_ticket',$datas);
        }
    ...
    //    $data['all_ticket']=$query->getResult();
        ...
        if($manage_templates[0]['settings_value'] == 'theme1')
        {
            return view('frontend/temp-one/support_ticket/all',$data);
        }
        if($manage_templates[0]['settings_value'] == 'theme2')
        {
            return view('frontend/temp-two/support_ticket/all',$data);
        }
    ...
    public function ticket_view($id)
    {
        ...
        if($manage_templates[0]['settings_value'] == 'theme1')
        {
            return view('frontend/temp-one/support_ticket/view',$data);

        }
        if($manage_templates[0]['settings_value'] == 'theme2')
        {
            return view('frontend/temp-two/support_ticket/view',$data);
        }
    ...
    public function ticket_edit($id)
    {
        ...
        return view('frontend/temp-two/support_ticket/edit_support_ticket');
    }
