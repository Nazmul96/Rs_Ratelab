...
$routes->add('/subscribe_submit','Home::subscribe_submit');

$routes->group('user',function ($routes) { 

$routes->add('user-profile/(:num)','UserController::ratelab/$1');
$routes->add('login','UserController::login');
$routes->add('forgot_password','UserController::forgot_password');
$routes->add('reset_password/(:any)','UserController::reset_password/$1');
$routes->add('user_registration','UserController::registration');
$routes->add('user_logout','UserController::user_logout');
$routes->add('email_verify/(:any)','UserController::email_verify/$1');
$routes->add('resend_verify_code/(:any)','UserController::resend_verify_code/$1');
...
//Policy pages----------------------------	
$routes->add('frontend/policy_details/(:any)', 'FrontendController::policy_details/$1');
...
$routes->add('support/ticket/edit/(:any)','SupportController::ticket_edit/$1');
...
$routes->group('frontend', function ($routes) {
	...
	//theme two additiional image------------------
	$routes->add('theme_two_image', 'FrontendManagerController::theme_two_image');
	...
	$routes->add('collaboration-section', 'FrontendManagerController::collaboration_section');
