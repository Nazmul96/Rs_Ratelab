...
class Validation
{
    ...
    //Subscriber validation-----------------
       public $SubscriberValidate = [
        'email_address' => [
            'rules'  => 'required|valid_email|is_unique[subscribers.email_address]',
             'errors' => [
    ...
    public $UserRegistrationValidate = [
       ...
       'last_name' => [
        ...
        'agree_policy' => [
            'rules'  => 'required',
             'errors' => [
                'required' => 'The Agree policy field is must required',
            ],
        ],

    ];

    public $UserRegistrationValidate_new = [
        'first_name' => [
            'rules'  => 'required',
             'errors' => [
                'required' => 'The First name field is required',
       ...
       'last_name' => [
        ...
        // ],
          ...
          'password' => [
            'rules'  => 'required|min_length[6]|regex_match[/^[0-9]{10}$/]',
             'errors' => [
                'required' => 'The Password field is required',
    ...
    public $emailVerrifyValidate = [
    'verify_code' => [
            'rules'  => 'required',
                'errors' => [
                'required' => 'Verify code field is required',
            ],
        ],

    ];
    //user forgot password--------------
    public $userForgotValidate = [
        'admin_email' => [
            'rules'  => 'required',
             'errors' => [
